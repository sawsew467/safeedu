            ...
            <View className="flex-1 px-6">
                <View className="flex-1 mt-14">
                    <View className="gap-1">
                        ...
                        <Text className="text-white text-base font-normal">Hãy nhập số điện thoại</Text>
                    </View>
                ...
                <View className="h-[13%] mb-5">
                    <Text className="font-normal text-lg text-white mb-4">Gửi tôi một mã xác nhận thông qua SMS</Text>
                    <TouchableOpacity
