        ...
        <SafeAreaView>
            <View style={styles.container}>
                <View style={styles.headerContainer}>
                    <Text style={[styles.headerText, { color: renderColor() }]}>{renderText()}</Text>
                ...
                <View style={styles.container_result}>
                    <View style={styles.circle_result}>
                        <ProgressScore percent={(data?.correctAnswer / data?.totalQuizz) * 100} />
                    </View>
                    <View style={styles.content_result}>
                        <View style={styles.container_text_result}>
                            ...
                            <View style={styles.correct_circle}>
                                <Text style={styles.correct_circle_text}>{data?.correctAnswer}</Text>
                            </View>
                        </View>
                        <View style={styles.container_text_result}>
                            <Text style={styles.incorrect_text}>Sai</Text>
                            <View style={styles.incorrect_circle}>
                                <Text style={styles.incorrect_circle_text}>{data?.totalQuizz - data?.correctAnswer}</Text>
                            </View>
                        </View>
                    </View>
                </View>
