        ...
        return (
          <View
            style={[
              styles.answer,
              itemStyle,
              choiceIndex === index && styles.incorrect_answer,
              correctAnswer === index && styles.correct_answer,
            ]}
          >
            <Text
              style={[
                styles.text_answer,
                (choiceIndex === index || correctAnswer === index) &&
                  styles.text_choice_answer,
              ]}
            >
              {item}
            </Text>
...
const GameTestTheoryModule = () => {
    ...
    setListAnswer(() => ({
      correctAnswer:
        correctAnswer === choiceIndex
          ? listAnswer.correctAnswer + 1
          : listAnswer.correctAnswer,
      listQuizz: [
        ...listAnswer.listQuizz,
        {
          question: question,
  ...
  const answers = React.useMemo(() => {
    return THEORY_TEST_DATA[questionIndex].answer.sort(
      () => Math.random() - 0.5
    );
  }, [questionIndex]);
  ...
  const correctAnswer = React.useMemo(() => {
    return answers.findIndex(
      (answer) => answer === THEORY_TEST_DATA[questionIndex].correctAnswer
    );
  }, [questionIndex]);
