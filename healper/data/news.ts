...
import congantinhlangson from "@/assets/images/news_image/congantinhlangson.jpg";
import news3_content_image from "@/assets/images/news_image/news3_content_image.jpg";
...
export const DATA: DataType[] = [
  ...
  },
  {
    ...
    content:
      "Bài báo nêu rõ vai trò quan trọng của Lực lượng tham gia bảo vệ an ninh, trật tự (ANTT) tại cơ sở tỉnh Lạng Sơn, dù mới thành lập từ tháng 7/2024. Hiện toàn tỉnh có 1.646 tổ bảo vệ với 5.038 thành viên, bố trí ở các thôn bản, tổ dân phố. Lực lượng này hỗ trợ Công an xã trong việc nắm bắt tình hình ANTT, phòng cháy chữa cháy, cứu nạn, giữ gìn trật tự, được ví như “cánh tay nối dài” của lực lượng Công an.\nĐể nâng cao hiệu quả hoạt động, Công an tỉnh đã tổ chức các lớp tập huấn, bồi dưỡng kiến thức cho lực lượng bảo vệ ANTT ở cơ sở. Từ tháng 7/2024, lực lượng này đã phối hợp tuần tra 578 lần, giải quyết 53 vụ việc, hòa giải 19 mâu thuẫn, vận động thu hồi vũ khí và giáo dục nhiều đối tượng vi phạm. Qua đó, lực lượng ANTT đã giúp giảm thiểu vi phạm, giữ vững an ninh trật tự tại địa phương, đặc biệt tại các xã, vùng biên giới.\nNhững kết quả đạt được chứng minh vai trò thiết yếu của lực lượng bảo vệ ANTT trong việc hỗ trợ an ninh cộng đồng, tạo động lực để họ tiếp tục phấn đấu bảo vệ cuộc sống bình yên cho nhân dân.",
    caption:
      "Công an tỉnh Lạng Sơn tăng cường bồi dưỡng nghiệp vụ cho Lực lượng tham gia bảo vệ ANTT ở cơ sở.",
  },
  {
    id: "3",
    title:
